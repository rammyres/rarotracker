...
class Config:
    ...
    # --- Telegram (alerta via bot, gratuito) ---
    # TELEGRAM_BOT_TOKEN: crie um bot com @BotFather no Telegram e cole o token aqui.
    # TELEGRAM_CHAT_ID: seu chat ID (fale com @userinfobot, ou veja o README).
