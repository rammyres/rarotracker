...
from notifications import (
    ...
    send_push_alert,
    send_telegram_alert,
    build_availability_email,
    build_availability_telegram_text,
)
...
def notify_availability(book, listing, source, push_subscriptions):
    ...
    send_telegram_alert(build_availability_telegram_text(book, listing, source))
    ...
    db.session.add(NotificationLog(book_id=book.id, source_id=source.id, channel="telegram"))
